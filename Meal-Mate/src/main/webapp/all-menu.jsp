...
<%@ page import="dbConnection.DBconnection,services.DishesQueries" %>
<!DOCTYPE html>
<html>
	<head>
        <meta charset="utf-8">
                                        ...
                                        <div class="table-responsive m-t-40">
                                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
													...
													<%
													HashMap<Integer,HashMap<String,String>>dish = null;
												try{
														...
														for(Map.Entry<Integer,HashMap<String,String>>entry:dish.entrySet()){
													        ...
													        out.println("<tr>");
													        out.println("<td>" + dish_details.get("r_name") + "</td>");
													        out.println("<td>" + dish_details.get("dish_title") + "</td>");
													        out.println("<td>" + dish_details.get("slogan") + "</td>");
