                            ...
                            <div class="container-fluid">
                                ...
                                <div class="col-lg-12">
                                    <div class="card card-outline-primary">
                                        ...
                                        <div class="card-body">
                                            <form action='DishesAddController' method='post' >
                                                <div class="form-body">
                                                    ...
                                                    <div class="row p-t-20">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group has-danger">
                                                                ...
                                                                <input type="text" name="image" id="lastName" class="form-control form-control-danger" placeholder="12n">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="rs_id" class="form-control form-control-danger" placeholder="Restaurant ID">
                                                            </div>
                                                        </div>
